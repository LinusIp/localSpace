//! The one place the binary writes to the operator (`CLAUDE.md`, "Coding
//! standards": user-facing CLI output is legitimate, but it lives in one
//! module; everything else goes through `tracing`).
