...
export const BoardIcon = icon("board", ["M3 4h18v14H3z", "M7 9h5", "M7 13h8"]);
export const StoreIcon = icon("store", ["M4 8h16l-1.2 10.2a2 2 0 0 1-2 1.8H7.2a2 2 0 0 1-2-1.8L4 8z", "M9 8V6a3 3 0 0 1 6 0v2"]);
export const PeopleIcon = icon("people", ["M16 20v-1.6a3.4 3.4 0 0 0-3.4-3.4H6.4A3.4 3.4 0 0 0 3 18.4V20", "M21 20v-1.6a3.4 3.4 0 0 0-2.6-3.3", "M15.5 4.2a3.5 3.5 0 0 1 0 6.6"], [["circle", 9.5, 7.5, 3.5]]);
export const ShieldIcon = icon("shield", ["M12 3 4.5 6v6c0 4.4 3.1 8.2 7.5 9 4.4-.8 7.5-4.6 7.5-9V6L12 3z"]);
export const ArrowUpIcon = icon("arrow-up", ["M12 19V5", "M6 11l6-6 6 6"]);
export const InfoIcon = icon("info", ["M12 11v5", "M12 8h.01"], [["circle", 12, 12, 9]]);
export const MessageIcon = icon("message", ["M21 11.5a8 8 0 0 1-8.5 8 9 9 0 0 1-3.9-.9L3 20l1.4-4.2a8 8 0 0 1-.9-3.8 8 8 0 0 1 8-8 8 8 0 0 1 9.5 7.5z"]);
export const WorkspaceIcon = icon("workspace", ["M3 7h18v13H3z", "M3 7l2-3h14l2 3", "M10 12h4"]);
