...
`localspace-server` is what both speak. Steps 1 to 4 of the v2 build order are done:
...
approval. 205 tests pass, including an end-to-end suite that drives both real
